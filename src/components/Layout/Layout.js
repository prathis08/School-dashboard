...
const Layout = ({ children }) => {
    ...
    const allMenuItems = [
      ...
      },
      {
        ...
        subItems: [
          ...
          { id: "fee-management", name: "Fee Management", path: "/fees" },
        ],
      },
  ...
  return (
    <div className="flex h-screen bg-gray-50 dark:bg-gray-900">
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 shadow-lg transform flex flex-col ${
      ...
      >
        ...
        <div className="flex items-center justify-between h-16 px-6 border-b border-gray-200 dark:border-gray-700 flex-shrink-0">
          ...
          <button
            ...
            className="lg:hidden p-1 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
          >
        ...
        {/* Navigation */}
        <nav className="mt-6 px-6 flex-1 overflow-y-auto pb-6 scrollbar-hide">
          ...
          {/* Error state */}
          {error && (
            <div className="text-red-500 dark:text-red-400 text-sm p-2 bg-red-50 dark:bg-red-900/20 rounded-lg mb-4">
          ...
          <div className="text-xs font-semibold text-gray-400 dark:text-gray-500 uppercase tracking-wider mb-3 mt-8">
            OTHER
          </div>
          <ul className="space-y-1">
            {otherItems.map((item) => {
        ...
        <div className="flex-shrink-0 mt-6 p-6 border-t border-gray-200 dark:border-gray-700">
          <div
            onClick={() => navigate("/profile")}
            className="flex items-center mb-4 cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-lg transition-colors duration-200"
          >
        ...
        <header className="bg-white dark:bg-gray-800 shadow-sm border-b border-gray-200 dark:border-gray-700 h-16">
          <div className="flex items-center justify-between h-full px-6">
            ...
            <button
              ...
              className="lg:hidden p-2 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300"
            >
            ...
            <div className="flex-1 max-w-lg mx-4 relative">
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <Icons.Search className="h-5 w-5 text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500" />
                </div>
                <input
                  type="text"
                  value={searchQuery}
                  ...
                  className="w-full pl-10 pr-4 py-2 border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 placeholder-gray-400 dark:placeholder-gray-500 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100"
                  ...
                  {searchResults.map((item, index) => (
                    ...
                    >
                      <div className="flex items-center justify-between">
                        ...
                        <Icons.ArrowRight className="w-4 h-4 text-gray-400 dark:text-gray-500 dark:text-gray-400 dark:text-gray-500" />
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="relative p-2 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200"
                title={
              ...
              {/* Notifications */}
              <button className="relative p-2 text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-lg transition-colors duration-200">
              ...
              <div
                onClick={() => navigate("/profile")}
                className="flex items-center cursor-pointer hover:bg-gray-50 dark:hover:bg-gray-700 p-2 rounded-lg transition-colors duration-200"
              >
